...
class DaysOfWeekScreen extends ConsumerStatefulWidget {
  @override
  _DaysOfWeekScreenState createState() => _DaysOfWeekScreenState();
}

class _DaysOfWeekScreenState extends ConsumerState<DaysOfWeekScreen> {
  final Map<String, String> mediaList = AppConstants().dayofsweek;
