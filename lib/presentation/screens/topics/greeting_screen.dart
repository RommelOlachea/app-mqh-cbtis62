...
class _GreetingScreenState extends State<GreetingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredIndications = AppConstants().greeting.entries.where((entry) {
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: Image.asset(
                'assets/icon/topics/saludos.png', // Ajusta la ruta de tu imagen
                width: 35,
                height: 35,
              ),
            ),
                                    ...
                                    return AlertDialog(
                                      ...
                                      content: Column(
                                        ...
                                        children: [
                                          ...
                                          Image.asset(
                                            'assets/topics/greeting/${entry.value}', // Ajusta la ruta de tu imagen
