...
class PrepositionsScreen extends ConsumerStatefulWidget {
  @override
  _PrepositionsScreenState createState() => _PrepositionsScreenState();
}

class _PrepositionsScreenState extends ConsumerState<PrepositionsScreen> {
  final Map<String, String> mediaList = AppConstants().prepositions;
