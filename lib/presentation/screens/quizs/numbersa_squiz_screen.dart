...
class NumbersaSquizScreen extends ConsumerStatefulWidget {
  const NumbersaSquizScreen({Key? key}) : super(key: key);

  @override
  _NumbersaSquizScreenState createState() => _NumbersaSquizScreenState();
}

class _NumbersaSquizScreenState extends ConsumerState<NumbersaSquizScreen> {
  final Map<String, String> allNumbers = Map.fromEntries(
  AppConstants().numbers.entries.take(10)
);
